...
- **v0.0.8 (2026-06-16)** — Git Action별 애니메이션 선택/프리뷰 UX 추가
  - Added:
    ...
    - Character Picker 안에 **Action Preview** 섹션 추가
    - 각 Git Action 행에서 선택한 애니메이션을 즉시 확인할 수 있는 **Preview** 버튼 추가
    - Command Palette: **Git Effects: Preview Action**
  - Changed:
    - Character Picker 화면을 **Action Preview → Character Library** 순서로 정리
    - 액션 설정 UI를 이벤트 설명/애니메이션 선택/프리뷰 버튼 구조로 개선
